...
A Path of Exile reference tool for skill gem imbuement outcomes. Single-page React app that displays skill gems, their colors (red/green/blue), and supported gem combinations. Deployed to GitHub Pages at `/poe-imbued-gems/`.
